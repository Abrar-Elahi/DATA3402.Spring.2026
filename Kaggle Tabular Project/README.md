...
IQR-based outliers were detected in several features but retained, as they represent real structual variation.
...
Random Forest — Consists of 100 decision trees: captures non-linear boundaries and feature interactions without requiring scaling.
...
No training curves as both models are non-iterative (fit in one pass); there are no loss-vs-epoch curves to plot
...
- Cinar, I., Koklu, M., & Tasdemir, S. (2020). *Classification of Raisin Grains Using 
  Machine Vision and Artificial Intelligence Methods*. Selcuk University, Konya, Turkey.
